...
final class ProfilePageJsonLdBuilder extends AbstractJsonLdBuilder
{
    ...
    public function setMainEntity(string|array $mainEntity): static { return $this->set('mainEntity', $this->normalizeTypedValue($mainEntity, 'Person', 'name')); }
