...
- Executed `composer validate --strict` from `Modules/Seo/`.
...
- Executed `vendor/bin/phpstan analyse` from `Modules/Seo/`.
...
- Executed `find src -name "*.php" -exec php -l {} \;` from `Modules/Seo/`.
