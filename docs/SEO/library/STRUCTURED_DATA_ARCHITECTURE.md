...
-   **Scoped Validation Only:** The validator provides generic structural checks and scoped structural/property-range semantic validation for the four Phase 13P types above. It is not complete Schema.org semantic or lexical proof, does not deeply validate every Schema.org type, and does not check URL reachability.
