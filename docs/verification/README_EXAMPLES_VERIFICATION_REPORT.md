...
All of the provided snippets were extracted into standalone PHP scripts locally, using `vendor/autoload.php` inside the `` directory, and executed directly via the PHP CLI.
